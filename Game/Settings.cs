...
namespace BeatDown.Game
{
	public class Settings
	{
		...
		public  String DataDirectory = Environment.GetFolderPath (Environment.SpecialFolder.ApplicationData) + "BeatDown/";
		public String SaveDirectory =  Environment.GetFolderPath (Environment.SpecialFolder.ApplicationData) + "BeatDown/save/";
